...
## Bivariate analysis
### Bivariate plots
```{r bivariate-plots, warning=FALSE}
...
density_plot(df, update_to_exp) +
  ...
  scale_y_sqrt() +
  labs(title = 'Density of time to expiration by trust', y = 'Density') +
  theme_ipsum()
...
### Barplot - num nameservers by trust

```

### Registation time density by trust
### Update to expiration density by trust
### Site age and ranking, by trust
### Barplot - num nameservers by trust
### Domain length by age
### Domain name top 20 words by trust, lollipop
